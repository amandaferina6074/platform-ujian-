...
<head>
    ...
    {{-- 
    ================================================================
    PERBAIKAN: Tambahkan baris ini untuk memuat app.js (Alpine.js)
    ================================================================
    --}}
...
<body>
    ...
    {{-- 
    Script @yield('scripts') atau @stack('scripts') bisa ditambahkan di sini 
    jika Anda membutuhkannya nanti. Tapi untuk Alpine.js, @vite di <head> sudah cukup.
    --}}
</body>
</html>